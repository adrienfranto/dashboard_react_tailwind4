  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 '>
     {stats.map((stats,index)=>{
        ...
        hover:shadow-slate-200/20 dark:hover:shadow-slate-900/20 transition-all duration-300 group ' key={index}>
            <div className='flex items-start justify-between'>
                <div className='flex-1'>
                    ...
                    <div className='flex items-center spaces-x-2'>
                        {stats.trend==="up" ? <ArrowUpRight className='w-4 h-4 text-emerald-500'/> : <ArrowDownRight className='text-red-500'/>}
            ...
            <div className='mt-4 h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden'>
                <div className={`w-full bg-gradient-to-r ${stats.color} rounded-full 
